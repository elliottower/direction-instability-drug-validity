...
\citep{subramanian2017next,li2020comprehensive}, and construct-validity
...
to the on-target direction and attenuate the observed correlation: the true
on-target association is likely stronger than the measured $\rho = 0.38$.
...
(spanning HDAC1, HDAC2, and HDAC6 targets; full list in Additional files)
...
magnitude path from perturbation strength to the metric. Direction
