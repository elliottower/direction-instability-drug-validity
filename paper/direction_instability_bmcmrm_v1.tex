...
% TODO: Reformat to BMC article template (bmc_article.cls) before submission.
% BMC MRM: ~3000-5000 words main text. Vancouver (numbered) references.
% Template: https://www.biomedcentral.com/getpublished/writing-resources
...
\author{Elliot Tower}
\affil{Independent Researcher, elliot@elliottower.ai}
...
% TODO: Switch to Vancouver numbered style (unsrtnat or similar)
% when reformatting to bmc_article.cls
